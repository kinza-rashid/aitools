...
if cbtn and (a != 4):
    ...
    with c1:
        ...
        if col1.button("Explore GPT-4"):
            webbrowser.open_new_tab('https://openai.com/product/gpt-4')
    ...
    with c2:
        ...
        if col1.button("Explore Lablab AI"):
            webbrowser.open_new_tab('https://lablab.ai/')
    ...
    with c3:
        ...
        if col1.button("Explore Rytr   "):
            webbrowser.open_new_tab("https://rytr.me/")
    ...
    with c4:
        ...
        if col1.button("Explore Runway"):
            webbrowser.open_new_tab("https://app.runwayml.com/")
    ...
    with c5:
        ...
        if col1.button("Explore LALAL"):
            webbrowser.open_new_tab("https://lalal.ai")
    ...
    with c6:
        ...
        if col1.button("Explore BOOST AI"):
            webbrowser.open_new_tab("https://www.boost.ai/")
    ...
    with c7:
        ...
        if col1.button("Explore Avatar"):
            webbrowser.open_new_tab('https://avatarai.me/')
    ...
    with c8:
        ...
        if col1.button("Explore Stable Diffusion"):
            webbrowser.open_new_tab('https://stablediffusionweb.com/')
    ...
    with c9:
        ...
        if col1.button("Explore Midjourney"):
            webbrowser.open_new_tab("https://www.midjourney.com/")
    ...
    with c10:
        ...
        if col1.button("Explore Synthesia"):
            webbrowser.open_new_tab("https://www.synthesia.io/")
    ...
    with c11:
        ...
        if col1.button("Explore My Character AI"):
            webbrowser.open_new_tab("https://mycharacter.ai/")
    ...
    with c12:
        ...
        if col1.button("Explore Adept AI"):
            webbrowser.open_new_tab("https://www.adept.ai/act")
    ...
    with c13:
        ...
        if col1.button("Explore ELai"):
            webbrowser.open_new_tab('https://app.elai.io/')
    ...
    with c14:
        ...
        if col1.button("Explore Luma Labs"):
            webbrowser.open_new_tab('https://lumalabs.ai/')
    ...
    with cc1:
        ...
        if col1.button("Genei"):
            webbrowser.open_new_tab("https://www.genei.io/")
    ...
    with cc3:
        ...
        if col1.button("Explore Word Tune"):
            webbrowser.open_new_tab('https://www.wordtune.com/')
    ...
    with cc4:
        ...
        if col1.button("Explore Text Blaze"):
            webbrowser.open_new_tab('https://blaze.today/')
    ...
    with cc7:
        ...
        if col1.button("Explore Otter"):
            webbrowser.open_new_tab("https://otter.ai/")
    ...
    with cc8:
        ...
        if col1.button("Fireflies"):
            webbrowser.open_new_tab("https://fireflies.ai/")
    ...
    with cc11:
        ...
        if col1.button("Explore AI Writer"):
            webbrowser.open_new_tab('https://ai-writer.com/')
    ...
    with cc12:
        ...
        if col1.button("Explore Pictory"):
            webbrowser.open_new_tab('http://pictory.ai')
